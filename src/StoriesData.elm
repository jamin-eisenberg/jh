...
initialStories =
    Stories
        (Array.fromList
            [ { title = "The Pankows"
              , description = [ Story.text "We'll try to keep the exposition minimal, because this is the story of our lives together. Hailey Pankow was born to Juli and Dale Pankow in Brockville, Canada. She moved to Lima, Ohio in 2006, and then to Newtown, CT in 2010." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 984114000000)
              , iconImageName = "the-pankows.png"
              , aabb = { x = 2016, y = 83, width = 191, height = 147 }
              }
            , { title = "The Eisenbergs"
              , description = [ Story.text "Jamin Eisenberg was born to Marla Eisenberg in St.Paul, Minnesota. He moved to Minneapolis in 2003." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1006664400000)
              , iconImageName = "the-eisenbergs.png"
              , aabb = { x = 1772, y = 80, width = 178, height = 183 }
              }
            , { title = "Northeastern"
              , description = [ Story.text "We both started at Northeastern in 2019. Jamin majored in Computer Engineering and Computer Science. Hailey majored in Mechanical Engineering with a minor in Computer Science. After we started dating, we figured out that we had actually been in a class together in our second semester: Fundamentals of Computer Science 1. It was a big class, so we never actually interacted, but it's a fun fact. \n\nHailey had a couple other CS classes for her minor, so in our last semester (after we had been dating for a while), we decided to take Computer Systems together. It was a lot of fun to go to lectures together, and we were partners for all the homeworks - pretty ideal!" ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1567569600000)
              , iconImageName = "northeastern.png"
              , aabb = { x = 252, y = 1418, width = 203, height = 202 }
              }
            , { title = "First Meeting"
              , description = [ Story.text "The summer after our sophomore year, people were getting vaccinated, COVID restrictions were lightening, and Northeastern was resuming resident events. One of the first events was a picnic on the Charles River Esplanade, specifically for Northeastern students living in the \"leased properties\" (one of a few buildings Northeastern didn't actually own).\n\nWe met at some benches close to our building. Hailey was the first one there (of course) and Jamin was the second. We didn't end up talking until some other, more extroverted people arrived. It was an eclectic group that signed up, but everyone was very friendly, eager to talk with people besides the ones they'd been living with. About 10 of us all walked from Northeastern's campus to the Esplanade. It was a lovely evening, and the picnic ended up lasting until the sun went down. \n\nOn the way back, the group was more comfortable with each other so we started out walking in a sort of mob. But the two of us tend to walk faster than most, so we ended up chatting together. We mostly talked about what classes we enjoyed and what we do for fun, which worked out well for us as we have a lot of common interests: math, engineering, reading, board games, etc. We kept getting too far ahead of the group as we were walking and had to stop to let them catch up. When we all got back, a bunch of us exchanged numbers.\n\nOrdinarily, Hailey probably wouldn't have gone, but her roommate Aidan had been out of town for a few weeks, and Hailey wanted to spend time with some other people. Jamin almost decided not to go because he had been walking around Harvard for most of the day and was feeling tired, but he wanted to make some new friends. We often talk about how different our lives might have been if Aidan was in town or Jamin decided he was too tired or even if it had rained. We also talk about how it was such a good first meeting for us. Neither of us meet new people very often, and it was great that everyone was so open to talking because it was right after COVID." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1621569600000)
              , iconImageName = "first-meeting.png"
              , aabb = { x = 1245, y = 1039, width = 254, height = 238 }
              }
            , { title = "First Game Night"
              , description = [ Story.text "The few people that exchanged numbers at the picnic where we first met ended up getting together a couple times. The first outing was to Brookline Booksmith, a bookstore. The second activity was playing board games in Jamin's apartment. We played a couple different games: Coup, Don't Mess With Cthulhu (pictured), and some others that we don't remember now. It was a lot of fun, and at this point we were feeling more comfortable around each other.\n\nWe both love board games, and still play plenty - at least once or twice a week. Don't Mess With Cthulhu remains one of our favorites. Some of our other favorites include The Crew, Ticket to Ride, Codenames, Bohnanza, So Clover, Kingdomino, Letter Jam, and Mantis Falls." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1622779200000)
              , iconImageName = "first-game-night.png"
              , aabb = { x = 884, y = 1640, width = 282, height = 258 }
              }
            , { title = "Farmers Market"
              , description = [ Story.text "One of our other outings with our \"starting group\" after the picnic was Haymarket, a very affordable outdoor produce market. It quickly became a weekly outing for whoever was interested in going. We usually just hopped on the orange line from Northeastern and spent some time together buying fruits and vegetables for the week. We also sometimes got lunch at Boston Public Market which is right next door. " ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1624075200000)
              , iconImageName = "farmers-market.png"
              , aabb = { x = 205, y = 1156, width = 172, height = 256 }
              }
            , { title = "Book Loan"
              , description = [ Story.text "At our second game night, we talked about The Martian by Andy Weir, which we had both read. Hailey hadn't read Artemis though, an earlier book by the same author. Jamin owned a copy and offered to loan it to her. We lived in the same building at the time, so it was very easy to stop by and drop it off. Actually, Jamin was planning to use the opportunity to ask Hailey on a date, but Aidan, her roommate, answered the door, so Jamin chickened out. Hailey read it and returned it on our second date. \n\nSince then, we've shared many books, but for whatever reason we typically listen to or read sci-fi together. Some of our favorites include Project Hail Mary, short stories by Ted Chiang (Stories of Your Life and Others and Exhalation), and short stories by Isaac Asimov." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1624248000000)
              , iconImageName = "book-loan.png"
              , aabb = { x = 1752, y = 1382, width = 180, height = 256 }
              }
            , { title = "First Date"
              , description = [ Story.text "Up until our first date, we had pretty much exclusively texted about going to Northeastern's game club together. One of us would ask the other if they wanted to go that night, and inevitably that day wouldn't work for the other. This happened again on July 2nd, but this time Jamin responded by saying that he'd rather take Hailey to dinner and get to know each other better. Hailey said yes and we decided to meet in Harvard Square! \n\nWe walked around the square for a bit, evaluating our dinner options and chatting. We settled on The Maharaja, an Indian restaurant (hence the samosa icon). We were both pretty nervous because besides our first meeting, we hadn't really talked one on one before. Conversation was a little stilted, but we both relaxed a little when we admitted that we weren't used to going on dates. We talked about the basics, mostly: our families, our daily lives, etc. The restaurant looks out onto the street, so we talked plenty about passers-by, which is still one of our favorite activities in public. Once, we checked in afterward and let each other know that we had a good time!\n\nEvery year on our first date anniversary we have Indian food, and we usually talk about our first date and our relationship since then." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1625198400000)
              , iconImageName = "first-date.png"
              , aabb = { x = 1559, y = 407, width = 236, height = 215 }
              }
            , { title = "\"Long\" Distance"
              , description = [ Story.text "The day of our first date was the day Jamin bought furniture for his new apartment (the lease started on 7/1). His new apartment was in Cambridge, about a 20 minute bike ride from Hailey, or a 35 minute bus. This trend continued for our last two years at Northeastern. Jamin lived in three different places, relatively far from campus, and Hailey stayed in the same building that we lived in when we met until graduation.\n\nWhile it was unfortunate timing for the start of our relationship, we think the distance in the beginning was probably good for us in the long run. It did start to wear on us after a while - it's tough to commit to traveling for a while just to see each other." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1625198400000)
              , iconImageName = "long-distance.png"
              , aabb = { x = 1513, y = 1883, width = 241, height = 135 }
              }
            , { title = "Second Date"
              , description = [ Story.text "For our second date, we walked around the Fens (a park), got some ice cream, and saw a movie. Hailey returned Artemis, the book she had borrowed. We talked about Artemis, as well as some other books, about being outdoors, and some other miscellaneous things. We were both very sticky after ice cream and we spent a while walking around trying to find somewhere we could wash our hands. That ended up being a drinking fountain. Jamin chose this time to ask Hailey if she wanted to hold hands as we walked to the movie, and our wet hands ended up making that a very slippery and overstimulating experience. We didn't hold hands again for a few months.\n\nOverall, it was a much slower-paced and more comfortable date. Hailey and her roommate Aidan ended up coming over the following day for dinner with Jamin's roommates, which we think helped establish that we were still also friends - a good place to be at the start of a relationship." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1625889600000)
              , iconImageName = "second-date.png"
              , aabb = { x = 1223, y = 727, width = 167, height = 329 }
              }
            , { title = "First Kiss"
              , description = [ Story.text "This one is a bit cheesy and a bit embarrassing so don't give us too hard a time about it.\n\nOur first and second dates did not end in a way that made a first kiss convenient. At the end of each, we were in crowded places, trying to bike or take the T back home. So, Jamin stopped by on the Wednesday after our second date, and texted Hailey that he had a question and asked if she could meet up real quick. He asked if she wanted to kiss and she said yes, but that her breath wasn't great at the moment. Jamin offered her a mint (he had already had one) and we had our first kiss! " ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1626235200000)
              , iconImageName = "first-kiss.png"
              , aabb = { x = 906, y = 52, width = 232, height = 196 }
              }
            , { title = "Isabella Stewart Gardner Museum"
              , description = [ Story.text "For our third date, we went to the Isabella Stewart Gardner museum. It's a very cool art museum with an interesting past that we won't get into here. We spent about two and a half hours at the museum, which is by far the longest Jamin has spent in a non-science museum. We mostly poked fun at all the strange objects, picking which ones we identified with the most and considering how things were made. That's now typical for us when we go to art museums, which we both do more together than we ever did alone.\n\nAfter the museum we walked around and had our first deeper conversation, about who we are and what we want our lives to be like." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1626580800000)
              , iconImageName = "isabella-stewart-gardner-museum.png"
              , aabb = { x = 916, y = 902, width = 174, height = 212 }
              }
            , { title = "Escape Room in a Box"
              , description = [ Story.text "For our fourth date, Hailey went over to Jamin's apartment for dinner and an escape room in a box. Jamin was very nervous about cooking for her because it was important to him that she thought he was a good cook. We enjoyed the meal and then did the EXIT escape game. These escape games have lots of puzzle components like those you might find in an escape room. We both enjoy them a lot, and we've done most of them at this point.\n\nWhile Jamin was waiting with Hailey at the bus stop, as he usually did, he asked if Hailey would like to be his girlfriend. She said yes! We agreed we'd pretty much known from the start that this would be a long-term relationship." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1627099200000)
              , iconImageName = "escape-room-in-a-box.png"
              , aabb = { x = 665, y = 52, width = 209, height = 218 }
              }
            , { title = "Sharing Music"
              , description = [ Story.text "Jamin has always had a sort of main playlist that he listens to exclusively (which has evolved over time from \"Paradise by Proxy\" to \"The Good of The Best\" to \"The Better of The Best\" to \"The Best of The Best\"). Just about a month into us starting to date, he shared his playlist with Hailey. Hailey actually listened to the playlist at work! It wasn't until we graduated that he gave her permission to edit it though. \n\nNow we have a playlist together (the JH playlist), primarily comprised of The Beach Boys, ABBA, 80s synth pop, and 2010s rock. Upbeat songs only! \n\nJamin's tastes have moved more into new wave and dark electronica, while Hailey likes more show tunes and sea shanties." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1627963200000)
              , iconImageName = "sharing-music.png"
              , aabb = { x = 1039, y = 1497, width = 210, height = 205 }
              }
            , { title = "Game Club"
              , description = [ Story.text "After a full month of dating, we still hadn't gone to Northeastern's game club, the thing that initiated conversation between us! We decided to make it happen, finally. Jamin had been going to game club since the start of freshman year, and was eager to introduce Hailey to it. He was a little nervous, because game club can be a little overwhelming, but Hailey had fun! Game club is where we were introduced to The Crew, which always had us coming back for more. We ended up going together most Fridays through graduation!" ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1628308800000)
              , iconImageName = "game-club.png"
              , aabb = { x = 288, y = 1783, width = 232, height = 185 }
              }
            , { title = "Handmade Gifts"
              , description = [ Story.text "We both like to make gifts for each other, rather than buying things, but Hailey really excels here. She loves to knit and crochet, and Jamin is lucky that the things she can make always make for great gifts! She has made him many things over the years: little stuffed dinosaurs, fidget toys, a real-looking heart, big stuffed candy hearts, a stingray, a frog, a pigeon, coasters, a little lambda-shaped guy, a phone stand, winter gear, a model of the solar system, little dolls of us and hammocks to go with them, a stuffed JH, and a tie-dye sweater! It's quite a collection, and pretty much all of them are on display somewhere in our apartment. Jamin loves all of them and Hailey loves making them for him!" ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1628568000000)
              , iconImageName = "handmade-gifts.png"
              , aabb = { x = 1843, y = 963, width = 389, height = 290 }
              }
            , { title = "Watching Taskmaster"
              , description = [ Story.text "One pretty obscure similarity we discovered early in our relationship was that we both love watching Taskmaster! Taskmaster is a British comedy show where, each season, five comedians \"compete\" in a bunch of tasks. The tasks are frequently strange and always interesting. We often pause the show and talk about how we would attempt a given task. Hailey likes the tasks more, as puzzles, while Jamin is a bigger fan of the comedy. \n\nWe got into it independently before we started dating, but we've continued watching it together. It's definitely our favorite show. We've seen all 20 seasons - most of them multiple times. (They're all free on YouTube if you're interested.)" ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1628740800000)
              , iconImageName = "watching-taskmaster.png"
              , aabb = { x = 995, y = 240, width = 232, height = 191 }
              }
            , { title = "Museum of Science"
              , description = [ Story.text "About a month into our relationship, Hailey went home to Connecticut for three weeks. Jamin was really looking forward to seeing her when she got back. Our first date when she got back was to Boston's Museum of Science. \n\nWe love the Museum of Science. It's got lots of fun interactive exhibits, but usually the best part is the lightning show. The museum has the world's largest air-insulated Van de Graaff generator, and it's super cool to watch the presenter go up in a Faraday cage that gets zapped with literally a million volts. Some of our other favorite exhibits include The Art of Illusion and Mathematica. We've been at least four or five times together, for several hours each." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1630814400000)
              , iconImageName = "museum-of-science.png"
              , aabb = { x = 1549, y = 1354, width = 236, height = 344 }
              }
            , { title = "Tie-dye"
              , description = [ Story.text "Of course, early on in our relationship we had to do tie-dye together! Jamin got dyes and shirts, and we made some tie-dye. Even though it was pretty difficult to do in an apartment with no yard and coin-operated laundry, they turned out well! \n\nHailey likes Jamin's love of tie-dye, but seldom wears it herself. She wouldn't want to steal his thing!" ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1631160000000)
              , iconImageName = "tie-dye.png"
              , aabb = { x = 1615, y = 751, width = 252, height = 222 }
              }
            , { title = "The Zoo"
              , description = [ Story.text "We love going to the zoo! Our first time going together, we could tell pretty quickly that this would be an oft-repeated outing. Our favorites are the Franklin Park Zoo and the Roger Williams Zoo (both AZA-accredited). It's a lot of fun to learn about the animals and watch them interact with each other. We especially like the monkeys, and one particular anteater. We think it's very likely that we will get a zoo membership when we have kids. The aquarium is similarly great. We know it seems a little silly, but most of our other favorite activities to do out of the house involve walking around and looking at interesting things, and the zoo is no different!\n\nHailey is a little funny at zoos and museums. She has lots of fun for a couple hours and then sort of hits a wall and immediately is no longer having fun and wants to go home!" ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1631937600000)
              , iconImageName = "the-zoo.png"
              , aabb = { x = 1688, y = 985, width = 254, height = 173 }
              }
            , { title = "Rocky Horror"
              , description = [ Story.text "Hailey, perhaps surprisingly, loves to go to The Rocky Horror Picture Show. For those who haven't been, it's a cult-classic musical that tends to have very interactive screenings. There's a weekly show with a shadow cast at the Boston Common theater that we've been to several times. Jamin was a little skeptical the first time we went, but we've always enjoyed going and have actually introduced it to some of our friends!\n\nThe lips icon was one of the many icons that appeared on Hailey's six-month-iversary gift to Jamin: a map of the Boston area with little embroidered icons representing the dates we went on. It was part of the inspiration for this much more ambitious version!" ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1632542400000)
              , iconImageName = "rocky-horror.png"
              , aabb = { x = 675, y = 749, width = 251, height = 162 }
              }
            , { title = "The Waver"
              , description = [ Story.text "Jamin created \"the waver\" for our three-month-iversary. The waver consists of two little blue boxes with a knob on the front and a hand sticking out of each one. We each had one in our apartment. When Jamin turns the knob on his box, the hand in Hailey's apartment waves, and when Hailey turns the knob on her box, the hand in Jamin's apartment waves. The knob controls the hand precisely, so we could vary the character of the wave. It's probably Jamin's most successful electronics project to date. He'd be happy to tell you how it works.\n\nBefore we started living together, we would wave to each other all the time: when we woke up, when we got back from school or work or seeing each other, and before we went to bed. We don't need it anymore, but it was a really great way for us to stay connected and just let each other know \"I'm thinking of you.\"" ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1633147200000)
              , iconImageName = "the-waver.png"
              , aabb = { x = 1948, y = 1186, width = 249, height = 266 }
              }
            , { title = "Thrifting"
              , description = [ Story.text "We are both pretty thrifty and love finding cheap or free things. It feels good to reduce waste while also benefitting from it. Probably our greatest victory is finding both of our bookshelves for free on the side of the road (\"Allston Christmas\"). They've served us very well. \n\nWe actually thrifted some things for our wedding too: the vases and the seating chart background.\n\nPractically every piece of furniture in our apartment came pre-owned, other than our bedroom set which is only temporary until we can get the heirloom set Jamin's grandpa made." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1634356800000)
              , iconImageName = "thrifting.png"
              , aabb = { x = 530, y = 1785, width = 181, height = 242 }
              }
            , { title = "First Halloween"
              , description = [ Story.text "For our first Halloween together, the two of us and our two friends went as Cars/Clue characters. Not just characters from the hit Pixar film series Cars. Not just potential murderers from the board game/movie Clue. Each of us were dressed as two characters simultaneously, one from each of the totally related franchises. Jamin was Mater and also Colonel Mustard. Hailey was Holly Shiftwell from Cars 2 and also Professor Plum. It's pretty much impossible to dress as two very distinct characters simultaneously, but we \"did it\" (primarily by dressing in a single color shared by both characters). Everyone had little wheel cufflinks that Hailey made as well. Given that we're not big party people, we ended up eating candy and watching Clue in our costumes. \n\nThat first year really set the standard for our Halloweens going forward. We usually have some lofty idea about what our costumes will be, go thrifting for things that roughly (very roughly) fit the idea, and watch a movie together. Our best year was definitely dressing up as the gang from Scooby-Doo." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1635652800000)
              , iconImageName = "first-halloween.png"
            ...
            , { title = "Saraceno"
              ...
              , iconImageName = "saraceno.png"
              , aabb = { x = 1980, y = 404, width = 219, height = 205 }
              }
            , { title = "Pottery Painting"
              , description = [ Story.text "There's a pottery studio in Brookline called The Clayroom that lets you pick out a piece of pottery and paint it for a small fee. We've gone several times and it's always a good time to paint something new. It usually takes a couple hours to do a few layers on your piece but it goes by super fast.\n\nOne year, Hailey got Jamin a throwing class for both of us at the Clayroom, which was a lot of fun. We made seven nesting bowls and got to paint them afterwards! We painted various fruits - see if you can tell who painted which ones (Jamin is very proud of himself that it's not too easy to tell which ones are worse and therefore his.) These bowls actually formed the basis of our fruit-themed kitchen decor!" ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1639198800000)
              , iconImageName = "pottery-painting.png"
            ...
            , { title = "Morning Workouts"
              ...
              , iconImageName = "morning-workouts.png"
              , aabb = { x = 1682, y = 1189, width = 282, height = 193 }
              }
            , { title = "Photography"
              , description = [ Story.text "Neither Jamin nor Hailey have a particular interest in taking photos, but our families really like it when we do. In combination,  those two facts have led us to primarily taking selfies or goofy photos. Jamin (a.k.a. \"Long-Arms McGee\") typically takes the selfies, which means that a lot of our pictures cut off at his right shoulder (see our Europe trip pictures in particular).\n\nSome of Jamin's favorite photos to take are of Hailey pumping gas. She's almost always the one to fill up the tank (which is very nice of her). While she's doing so, Jamin takes some action shots of her wearing some prize-winning expressions." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1711080000000)
              , iconImageName = "photography.png"
              , aabb = { x = 675, y = 490, width = 189, height = 171 }
              }
            , { title = "Toki Pona"
              , description = [ Story.text "Toki pona li toki pi lili. Mi mute li kama sona kepeken pu. Mi mute li wile toki kepeken toki pona.\n\nIn toki pona, this means roughly \"Toki pona is a minimalist language. We started learning it using the official toki pona book. We want to be able to speak in toki pona.\" \n\nToki pona is a constructed language that we tried to learn together. We learned all 120 words, as well as the grammar, but we didn't really use it enough for it to stick, unfortunately. It's generally difficult to form coherent sentences in because there's so few words, but we had a lot of fun learning about it." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1713585600000)
              , iconImageName = "toki-pona.png"
            ...
            , { title = "Pickleball"
              ...
              , iconImageName = "pickleball.png"
              , aabb = { x = 1674, y = 251, width = 145, height = 265 }
              }
            , { title = "Work Trip Apart"
              , description = [ Story.text "Hailey has to travel as part of her work for Instron, to install the systems she designs at customer sites. Sometimes Jamin goes with her, but sometimes it's not feasible, with his own work. Hailey's longest trip so far was to Shenyang, China, for 12 days. We miss each other a lot when she's away. For this particular trip, Hailey decided to surprise Jamin by hiding 100 little plastic ducks all over the apartment. Whenever Jamin was missing Hailey, he could go hunting for ducks! The ducks were hidden all over the place: there was one in his shoe, there was one in a board game we don't often play, there was one in every pair of his socks, there was one in his jacket pocket (he decided to leave that one in there) - truly everywhere. \n\nJamin found about 70 ducks while Hailey was gone. We lost track of how many we've found, but it's still less than 90. We've since moved, so there are either ducks well hidden in our old apartment or hidden deep in our belongings." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1735966800000)
              , iconImageName = "work-trip-apart.png"
              , aabb = { x = 1106, y = 931, width = 165, height = 133 }
              }
            , { title = "Pancakes"
              , description = [ Story.text "Growing up, Jamin's family made pancakes (or Belgian waffles) once on most weekends. When Jamin's mom got us a griddle pan, we started doing the same! We make King Arthur's simply perfect pancakes from scratch each week, and we add five chocolate chips to each pancake before flipping them. (That particular tradition came from when Jamin and his sister used to fight over who got which pancakes, but it really stuck.)\n\nPancakes is one of our favorite traditions and we hope to continue it when we have kids." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1737781200000)
              , iconImageName = "pancakes.png"
              , aabb = { x = 415, y = 1620, width = 228, height = 155 }
              }
            , { title = "New Library"
              , description = [ Story.text "When we toured our current apartment in Quincy, we had some time to spare in the area. We ended up at the Thomas Crane Public Library. It's a beautiful library about a block away from our apartment. We looked around, then sat and talked about our thoughts on moving to Quincy. The library itself played a part in our decision, honestly, being so close and so big.\n\nWe love the library. We mostly get books digitally now that we both have e-readers, but we constantly check out movies, TV shows, and board games. For a long time, we didn't have any streaming services and just checked out new things to watch from the library each week. (We recently folded and got Netflix so we can watch some TV shows as they're coming out.) The board games were a pleasant surprise - they have a good-size collection and it's really nice to be able to try games before buying the ones we really like for ourselves." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1741237200000)
              , iconImageName = "new-library.png"
              , aabb = { x = 665, y = 937, width = 227, height = 231 }
              }
            , { title = "Engaged! (Part 1)"
              , description = [ Story.text "Our engagement takes a little bit of explaining and a lot of describing, so strap in!\n\nOur decision to marry each other came to us gradually. We both knew that we loved each other very much, that we had built a great relationship for each other and for ourselves, and that we were emotionally ready to forever unify our lives. As much as you can be certain about these things, we are.\n\nAs many couples do, we lightly discussed marriage early on. After we had been living together for a while and growing closer and more comfortable, it was natural to talk about when exactly we wanted to get married, and what a proposal would look like. As is our custom, we made a list of things that we wanted to discuss before our proposal, and before getting married. It was a long list that we worked through over a few months including what marriage means to us, where we might live, housework, last names, finances, worst-case scenarios, kids, and many more.\n\nOne of the things on our list was what we wanted \"the proposal\" to look like. We always try to do things together and fairly, without trying to conform to specific gender roles, so the natural path was for each of us to propose to the other. There are some different ways to do this, but we settled on proposing to each other on the same day, one after the other. So \"Engaged (Part 1)\" is Jamin's proposal to Hailey in the morning, and part 2 is her proposal to him in the afternoon.\n\nJamin started by fake proposing to Hailey in the living room. The ring box, however, did not contain a ring, but contained a tiny envelope in the style of Taskmaster, one of our favorite TV shows. The tiny envelope described the general idea of a series of puzzles, and had a list of dates on the back. \n\nThe dates correspond to icons on a gift Hailey got for Jamin, that had an icon per date we went on in 2021, arranged on a map of Boston. When you play connect the dots with the icons corresponding to the dates, you get the digits 2, 1, 4, and 3.\n\nOn the back of a puzzle Jamin got her, he wrote the words ____th day of our relationship, and drew icons telling her to check her voicemail. Her voicemail contained a message of Jamin speaking Toki Pona, describing how to rearrange the digits from the previous clue.\n\nThe 1,324th day of our relationship was Valentine's Day of 2025, the day that Jamin gets Hailey a crossword every year.  With the crosswords, he had placed two pieces of paper with some tiny square cutouts that, when overlaid on the crosswords for 2024 and 2025, spelled \"ace\" and \"hearts.\"\n\nHailey checked the most significant deck of cards to our relationship, which is the cards she got Jamin for our second anniversary with the things she loves about him. The ace of hearts referenced the Waver Jamin had made for her, which so happened to be sitting out, attached to a piece of paper with a bunch of hands on it.\n\nJamin had reprogrammed the Waver such that, when the Waver's hand was lined up with each of the outlines on the paper in sequence, it started blinking Morse code. The Morse code spelled out \"last 30 days of wordle.\" \n\nJamin picks which letter we start our first guess with every day, and for the last 30 days, he had been spelling out the following: \"jamin eisenberg github io proposal.\" The Waver paper also had this clue on the back \"5-9.6.2/8.\" In combination, those yield a URL to a website Jamin had created (he took it down, no need to check).\n\nThe website opened with a picture of a steering wheel, so Hailey decided we should go to the car. There, she found an NFC tag that Jamin had placed (a little sticker you can scan with your phone). When she scanned it, the picture changed to Jamin sitting outside Ruggles station, where he sat to wait for her to come home from work every so often. It continued this way, with each picture indicating a place around Northeastern that was significant to us, and an NFC tag for her to scan to move to the next one. Thanks Sparrow for placing all those tags (and also playtesting and talking through how the entire proposal was going to work)! \n\nFrom Ruggles, we went to Snell Library, where Jamin first decided he loved Hailey. Then to East Village where we probably first saw each other because we had a class together. Then to the bench where we first met. Then outside her apartment where we had our first kiss. Then inside her old apartment (Jamin paid off the current residents to put an NFC tag in their apartment and let us in to the building on the day). Then to the Charles River Esplanade where they had the picnic on the day they first met.\n\nOn the esplanade, Jamin gave a short speech and proposed with a ring. She said yes! It was a dreary day, but we were so happy that it didn't matter. Neither of us could stop smiling.\n\nAfter the proposal, we headed back to Northeastern for an indoor picnic (because of the rain), which Aidan had kindly set up for us." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1743220800000)
              , iconImageName = "engaged!-(part-1).png"
              , aabb = { x = 1855, y = 792, width = 187, height = 219 }
              }
            , { title = "Engaged! (Part 2)"
              , description = [ Story.text "After lunch, it was Hailey's turn to propose!\n\nFor Jamin's birthday a few years back, Hailey got him a 2-3 player social deception game called Mantis Falls. He loves it and we play it relatively frequently. \n\nThe big reveal at the start of Hailey's proposal was that she had crafted a version of the game made of felt, themed around our relationship, called Jailey Falls In Love (a play on Mantis Falls). The rest of her proposal would be playing through the \"game\" where Jamin took a series of turns. On each turn, he would move down the road, revealing the next road card, and reveal one event card that talked about something in our relationship that was important to us. Then he would reveal one action card that would sort of recreate that event in a fun way!\n\nJust so you get the idea, one of the event cards said \"Surprise Event: Love. Effect: write down all the reasons you love the other player. Bonus: open item 2.\" This card commemorated our first anniversary. Item 2 was a journal Hailey had kept for several months leading up to the proposal detailing our daily lives together. The corresponding action card said \"Memory Lane. Choose a couple of pages to read from the book,\" which we did. \n\nHailey made 12 of each card (12 events, 12 actions, and 12 roads), so we won't detail them all here, but hopefully you can or were able to see them displayed at the wedding. They're beautifully made (Jamin says) and a lovely keepsake of the day. You may even recognize some of the icons used in this project!\n\nThe third to last action card said to go to Harvard Square and people watch. After that, Hailey walked Jamin down to the Charles river (yes, we both decided to propose right next to the river) and revealed the second to last card which asked Jamin if he wanted to marry her. He said yes! Her engagement gift to him was a watch called \"Enjoy the Ride.\" The second hand is a ferris wheel, so it's hard to tell exactly what second it is, which is sort of the central metaphor.\n\nAfter proposing, Hailey revealed the final cards. The event card said \"Future. Delight in everything the rest of your lives will bring together,\" and the action card told us to go to the Maharaja, where our first date was. We had a lovely dinner, and we mostly just talked about how fantastic the day was and how excited we were to get married!" ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1743220800000)
              , iconImageName = "engaged!-(part-2).png"
              , aabb = { x = 1571, y = 929, width = 213, height = 344 }
              }
            , { title = "Moving to Quincy"
              , description = [ Story.text "About a month after we proposed to each other, we moved out of our apartment in Cambridge into our new apartment in Quincy. It was a bittersweet time, because we would no longer be living with our friends, but we were looking forward to what was in store for us in Quincy. We mostly chose Quincy because the cost of living is lower than Boston and it's closer to Hailey's work (her commute to and from Cambridge was much longer). \n\nWe think we've landed pretty well here! We can walk to a bunch of restaurants and the library, and it's a lot easier to drive places that are farther than it was in Cambridge. Plus, we're still on the red line, so getting into the city is nice and easy for Jamin's work, and for date nights." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1746676800000)
              , iconImageName = "moving-to-quincy.png"
              , aabb = { x = 320, y = 1037, width = 272, height = 353 }
              }
            , { title = "Work Trip Together"
              , description = [ Story.text "Sometimes when Hailey goes on a work trip, Jamin comes along! (Which is much better for both of us, but it can be difficult for Jamin to come along because her trips are typically scheduled pretty close beforehand.) Our biggest work trip adventure was going to Denmark together. We were tourists for about 5 days, and then worked for 5 more. \n\nCopenhagen was a blast. We went to several castles and several museums, and we went on a boat tour of the city. We visited the round tower as well, which is an old 8-story observatory with no stairs, just one big ramp spiraling around the center until you get to the top. Its core is hollow, and you can stand inside it and see all the way down. We also spent a day in Malmö, Sweden, which is just a 40 minute train ride away. " ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1754971200000)
              , iconImageName = "work-trip-together.png"
              , aabb = { x = 83, y = 1301, width = 145, height = 260 }
              }
            , { title = "JH"
              , description = [ Story.text "Whoa, meta!\n\nAidan actually had the idea for the embroidery portion of this project a while ago, as a cool wedding sign for our guests to look at as they arrived. Shortly afterward, Jamin had the idea of bridging the gap between the icons and our stories associated with them in the form of this website. We were both very excited about the idea and decided to keep it a secret from everyone until the day of our wedding! So if you've ever wondered about our story or been disappointed by a brief answer from one of us about our relationship, consider this our gift to you - a hand-made mixed-media representation of who we are and who we have been as a couple.\n\nDetails! We knew this project would take a long time, so we started talking about what icons/stories to do and figuring out exactly how they would look. We talked about important parts of our relationship or events that brought us closer together and came up with icons to represent them. Then Hailey drew out all of the icons on a big piece of paper, then transferred them to wash-away stabilizer which she stuck on the fabric we bought for the sign. At the same time, Jamin started work on the website, figuring out how navigating between different stories would work. \n\nThen the longest part of the process began. Hailey started embroidering around January 9th, and finished on March 19th, spending an estimated 60 hours on it (estimated by approximately how much TV and movies we watch together because that's when she worked on it). Jamin wrote all the stories (yes, it's me writing in this moderately unfortunate mixed 3rd person and 1st person plural). After Hailey finished each icon, and after Jamin finished each story, we would ask each other what the other thought and adjust as necessary.\n\nIt's been a lot of fun to have a project that plays to both of our strengths and that we can truly collaborate on. We hope you enjoy it!" ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1762837200000)
              , iconImageName = "jh.png"
              , aabb = { x = 1351, y = 765, width = 222, height = 250 }
              }
            , { title = "Wedding"
              , description = [ Story.text "We're married! If you're reading this, it means we successfully finished this project on time and planned our wedding well enough that people showed up! We hope you enjoy or enjoyed it!\n\nWe've been looking forward to our wedding since our proposal a little over a year ago. We set our date about 9 months ago and started the long journey of planning our wedding. Since the beginning, we were dedicated to splitting the planning fairly (as we try to do everything), and we're quite happy with how the process went and how it turned out.\n\nWe originally decided on a wedding date of May 23rd, 2027, shortly after our proposal. We were relatively constrained on our date. We knew we wanted an outdoor wedding, so it had to be nice weather out. It had to be on a weekend so all of our out-of-town guests could make it. And it had to be on the 23rd of the month, because that's a tradition in Hailey's family. We ended up choosing to move to May 23rd, 2026 because it felt like 2 years was going to be a really long engagement (and a 2 year engagement typically means 2 years spent planning a wedding).\n\nThe ceremony was always the most important part to us, being the official unification of our lives together. (We're not huge party people either.) We loved putting the ceremony together and choosing what to include that would be most meaningful for us. The rings were a really big piece of it for us because they will be the most permanent, physical symbol of our marriage. We made them together a couple months before the wedding, and it was a really fun and felt very significant.\n\nWe're so grateful to our parents for all of their love and support throughout, and their excitement for us. We had regular \"team wedding\" calls throughout planning, which were super helpful in staying organized and being slightly less grounded than our usual selves.\n\nWe're also lucky to have wonderful wedding parties. We really appreciate all of their help in the planning and execution of our wedding and the events leading up to it. \n\nOn Monday after the wedding, we are off to our honeymoon! We are headed to an all-inclusive resort in Riviera Maya, Mexico, where we can relax and put our feet up for a week. We're really looking forward to it.\n\nAnd now we ride off into the sunset - I mean we start the rest of our lives together! We've got lots of thank you notes to write, we're going to get the ball rolling on adopting cats, we'll combine our finances, and of course we have to legally change our names.\n\nBeyond that, we'll get to work on maintaining our relationship for the rest of our lives. We'll continue our monthly check-ins and we will put in the work to stay in a loving, healthy marriage." ]
              , date = Date.fromPosix Time.utc (Time.millisToPosix 1779508800000)
              , iconImageName = "wedding.png"
