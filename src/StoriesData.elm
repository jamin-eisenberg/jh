...
initialStories =
    Stories
        (Array.fromList
            ...
            , { title = "Tie-dye"
              , description = [ Story.text "Of course, early on in our relationship we had to do tie-dye together! Jamin got dyes and shirts, and we made some tie-dye. Even though it was pretty difficult to do in an apartment with no yard and coin-operated laundry, they turned out well! ", Story.text "Hailey likes Jamin's love of tie-dye, but seldom wears it herself. She wouldn't want to steal his thing!", Story.image "tie-dye-shirts.jpg" ]
            ...
            , { title = "Moving in Together"
              , description = [ Story.text "After graduation, we moved in together! We decided the previous November that we wanted to live together, and shortly afterward decided to live with each of our previous roommates, Aidan and Sparrow. Together, we are JASH (Jamin, Aidan, Sparrow, Hailey). We assigned ourselves specific colors to uniformly apply to things around the apartment, especially board game player colors. Jamin is blue, Aidan is red, Sparrow is purple (or yellow if purple is unavailable), and Hailey is green.", Story.text "It was so much fun living together, and we're sorry that it had to end. Thanks to weekly check-ins, eating together, and each pair having been roommates beforehand, we are still very good friends.", Story.image "jash-ice-cream.jpg", Story.image "jash-painted.jpg" ]
            ...
            , { title = "New Library"
              , description = [ Story.text "When we toured our current apartment in Quincy, we had some time to spare in the area. We ended up at the Thomas Crane Public Library. It's a beautiful library about a block away from our apartment. We looked around, then sat and talked about our thoughts on moving to Quincy. The library itself played a part in our decision, honestly, being so close and so big.", Story.text "We love the library. We mostly get books digitally now that we both have e-readers, but we constantly check out movies, TV shows, and board games. For a long time, we didn't have any streaming services and just checked out new things to watch from the library each week. (We recently folded and got Netflix so we can watch some TV shows as they're coming out.) The board games were a pleasant surprise - they have a good-size collection and it's really nice to be able to try games before buying the ones we really like for ourselves." ]
